...
(“Application”). The Application is provided by {{ config('app.name', 'Laravel') }} (and may 
be provided by {{ config('app.name', 'Laravel') }} on behalf of a {{ config('app.name', 'Laravel') }} licensor or 
...
outlined in this Privacy Statement.
		<br><br>
		WHAT PERSONAL INFORMATION DOES {{ config('app.name', 'Laravel') }} COLLECT?
		<br><br>
...
whenever you interact with Application. For example, {{ config('app.name', 'Laravel') }} may 
...
(non-personally identifiable) form with our partners.
		<br><br>
		HOW DOES {{ config('app.name', 'Laravel') }} USE THE INFORMATION IT COLLECTS?
		<br><br>
		{{ config('app.name', 'Laravel') }} uses the information described in this Privacy 
Statement (i) internally, to analyze, develop and improve its products 
and services, and (ii) as set forth below in the “Will {{ config('app.name', 'Laravel') }} 
Share any of the personal information it Collects” section below.
		<br><br>
		APPLICATION PARTNER TREATMENT OF PERSONAL INFORMATION.
		<br><br>
		{{ config('app.name', 'Laravel') }} may provide personal information to the applicable 
...
application.
		<br><br>
		WILL {{ config('app.name', 'Laravel') }} SHARE ANY OF THE PERSONAL INFORMATION IT RECEIVES?
		<br><br>
...
or services to you. Unless we tell you differently, {{ config('app.name', 'Laravel') }}’s 
...
business assets that are transferred. Moreover, if {{ config('app.name', 'Laravel') }}, or 
substantially all of its assets were acquired, or in the unlikely event 
that {{ config('app.name', 'Laravel') }} goes out of business or enters bankruptcy, user 
...
that any acquirer of {{ config('app.name', 'Laravel') }} may continue to use your personal 
information as set forth in this policy.
		<br><br>
		Protection of {{ config('app.name', 'Laravel') }} and Others: We may release personal 
...
{{ config('app.name', 'Laravel') }}, our employees, our users, or others. This includes 
...
{{ config('app.name', 'Laravel') }}’s control, and such links do not constitute an 
endorsement by {{ config('app.name', 'Laravel') }} of those other applications/websites or 
the services offered through them. The privacy and security practices of
 ...
 covered by this Privacy Statement, and {{ config('app.name', 'Laravel') }} is not 
responsible for the privacy or security practices or the content of such
 websites.
		<br><br>
		WHAT PERSONAL INFORMATION CAN I ACCESS?
		<br><br>
		{{ config('app.name', 'Laravel') }} allows you to access the following information about 
you for the purpose of viewing, and in certain situations, updating that
 information. This list may change in the event the Application changes.
		...
		<br><br>
		Our site and the services available through {{ config('app.name', 'Laravel') }} are not 
intended for children under the age of 13. {{ config('app.name', 'Laravel') }} does not 
...
encourage you to participate in your child’s web experience.
		...
		<br><br>
		{{ config('app.name', 'Laravel') }} may amend this Privacy Statement from time to time. Use
...
Website, please send us a detailed message at agpb@winfred.work. We will 
